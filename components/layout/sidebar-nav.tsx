...
export const SidebarNav = memo(function SidebarNav({
  ...
  return (
    <aside className="sticky top-0 z-20 border-b border-line bg-panel/95 backdrop-blur lg:h-[calc(100vh-4rem)] lg:w-[296px] lg:flex-shrink-0 lg:overflow-y-auto lg:border-b-0">
      <div className="flex h-full flex-col px-4 py-4 sm:px-6 sm:py-6 lg:px-7 lg:py-8">
        <div className="mb-8 hidden lg:block">
          <p className="eyebrow">Developer OS</p>
          <h1 className="mt-3 text-[2.6rem] leading-none text-ink">
            Workspace
          </h1>
          <p className="mt-3 max-w-[18rem] text-sm leading-6 text-muted">
            A modular portfolio shell designed like a focused operating
            environment.
          </p>
        </div>
        ...
        <div className="mb-6 hidden rounded-[22px] border border-line bg-canvas p-4 lg:block">
          ...
          <p className="mt-2 text-sm leading-6 text-muted">
            Follow the system view to explore projects, experience, workflow,
            and contact details.
          </p>
        </div>
